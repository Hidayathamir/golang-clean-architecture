...
type S3Client interface {
	UploadImage(ctx context.Context, req model.S3UploadImageRequest) error
...
func (c *S3ClientImpl) UploadImage(ctx context.Context, req model.S3UploadImageRequest) error {
