...
func ConsumeUserFollowedEventForNotification(ctx context.Context, viperConfig *viper.Viper, usecases *dependency_injection.Usecases) {
...
func ConsumeUserFollowedEventForUpdateCount(ctx context.Context, viperConfig *viper.Viper, usecases *dependency_injection.Usecases) {
...
func SetupImageUploadedConsumer(ctx context.Context, viperConfig *viper.Viper, usecases *dependency_injection.Usecases) {
...
func ConsumeImageLikedEventForNotification(ctx context.Context, viperConfig *viper.Viper, usecases *dependency_injection.Usecases) {
...
func ConsumeImageLikedEventForUpdateCount(ctx context.Context, viperConfig *viper.Viper, usecases *dependency_injection.Usecases) {
	x.Logger.Info("setup consumer.ConsumeImageLikedEventForUpdateCount")
	consumerGroup := config.NewKafkaConsumerGroup(viperConfig, consumergroup.ImageLikedGroup2)
	consumer := messaging.NewImageConsumer(usecases.ImageUsecase)
...
func ConsumeImageCommentedEventForNotification(ctx context.Context, viperConfig *viper.Viper, usecases *dependency_injection.Usecases) {
...
func ConsumeImageCommentedEventForUpdateCount(ctx context.Context, viperConfig *viper.Viper, usecases *dependency_injection.Usecases) {
...
func SetupNotifConsumer(ctx context.Context, viperConfig *viper.Viper, usecases *dependency_injection.Usecases) {
